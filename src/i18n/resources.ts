    ...
    translation: {
      ...
      inspector: {
        ...
        panelForm: {
          ...
          ctaGeneratingDetail: '생성 요청 처리 중',
          ctaGeneratingTitle: '생성 진행 중',
          ctaNeedsPromptDetail: '입력 조건 0자',
      ...
      layerActions: {
        ...
        'impact-thought-thin': '임팩트 생각(얇음)',
        oval: '타원',
        'shock-thought-thick': '충격 생각(두꺼움)',
        'shock-thought-thin': '충격 생각(얇음)',
        'simple-thought-thick': '단순 생각(두꺼움)',
        'simple-thought-thin': '단순 생각(얇음)',
        sfx: '효과음',
        speech: '대사',
        thought: '생각',
      },
    ...
    translation: {
      ...
      inspector: {
        ...
        panelForm: {
          ...
          ctaGeneratingDetail: 'Generation request in progress',
          ctaGeneratingTitle: 'Generating',
          ctaNeedsPromptDetail: 'Input prompt 0 chars',
          ...
          ctaSelectedDetail:
            '{{count}} candidates · candidate {{number}} applied',
          ctaSelectedTitle: 'Candidate applied',
          ...
          generateMore: 'Generate more candidates',
      ...
      layerActions: {
        ...
        'impact-thought-thin': 'Impact Thought (Thin)',
        oval: 'Oval',
        'shock-thought-thick': 'Shock Thought (Thick)',
        'shock-thought-thin': 'Shock Thought (Thin)',
        'simple-thought-thick': 'Simple Thought (Thick)',
        'simple-thought-thin': 'Simple Thought (Thin)',
        sfx: 'SFX',
        speech: 'Speech',
        thought: 'Thought',
      },
